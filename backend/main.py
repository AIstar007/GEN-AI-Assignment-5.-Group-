# ----- again updated code below for reference -----
...
async def lifespan(app: FastAPI):
    ...
    try:
        print("🚀 Initializing AI Crew Rostering system...")
...
app = FastAPI(
    title="IndiGo Crew Rostering API",
    version="1.0.0",
    lifespan=lifespan
)
...
async def get_roster():
    ...
    try:
        ...
        return {"roster": roster_data, "metrics": metrics}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
if __name__ == "__main__":
    import uvicorn
    print("🌐 Starting IndiGo Crew Rostering API on http://127.0.0.1:8000")
